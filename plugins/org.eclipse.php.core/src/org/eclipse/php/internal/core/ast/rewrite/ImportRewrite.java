...
public final class ImportRewrite {
	 ...
	 */
	public static ImportRewrite create(ISourceModule cu, boolean restoreExistingImports) throws ModelException {
		if (cu == null) {
	...
	public static ImportRewrite create(Program astRoot, boolean restoreExistingImports) {
		...
		if (!(typeRoot instanceof ISourceModule)) {
	...
	private ImportRewrite(ISourceModule cu, Program astRoot, List<String> existingImports) {
