...
public class TypeInfoFilter {
	 ...
	 *         <code>text</code> e.g. "List" is a subFilter of "L". In this
	 *         case, the filters matches a proper subset of the items matched by
	 *         <code>text</code>.
	 */
	public boolean isSubFilter(String text) {
		...
		return fText.indexOf(ISearchPatternProcessor.TYPE_SEPARATOR, text.length()) == -1;
	}
