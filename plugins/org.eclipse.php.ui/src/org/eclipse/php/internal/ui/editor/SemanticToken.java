...
public final class SemanticToken {
	...
	private ASTNode fHighlightingNode;
	...
	void clear() {
		...
		fHighlightingNode = null;
	}

	public ASTNode getHighlightingNode() {
		return fHighlightingNode;
	}

	public void setHighlightingNode(ASTNode fHighlightingNode) {
		this.fHighlightingNode = fHighlightingNode;
	}
