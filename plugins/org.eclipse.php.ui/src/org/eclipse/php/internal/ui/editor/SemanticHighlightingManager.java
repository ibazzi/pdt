...
public class SemanticHighlightingManager implements IPropertyChangeListener {
	 ...
	 *            The preference store
	 */
	public void install(PHPStructuredEditor editor, PHPStructuredTextViewer sourceViewer, ColorManager colorManager,
		...
		if (fEditor != null) {
			...
			fPresentationReconciler = (PHPStructuredPresentationReconciler) fConfiguration
	 ...
	 */
	public void install(PHPStructuredTextViewer sourceViewer, ColorManager colorManager,
	...
	private void initializeHighlightings() {
		...
		for (int i = 0, n = fSemanticHighlightings.length; i < n; i++) {
			...
			fHighlightings[i] = new Highlighting(
