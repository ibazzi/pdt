...
public class SemanticHighlightingPresenter implements ITextPresentationListener, ITextInputListener, IDocumentListener {
	 ...
	 */
	private PHPStructuredTextViewer fSourceViewer;
	/** The background presentation reconciler */
	private PHPStructuredPresentationReconciler fPresentationReconciler;
	...
	public TextPresentation createPresentation(List<Position> addedPositions, List<Position> removedPositions) {
		PHPStructuredTextViewer sourceViewer = fSourceViewer;
		PHPStructuredPresentationReconciler presentationReconciler = fPresentationReconciler;
	...
	public void applyTextPresentation(TextPresentation textPresentation) {
		...
		int i = computeIndexAtOffset(fPositions, region.getOffset()),
				n = computeIndexAtOffset(fPositions, region.getOffset() + region.getLength());
		if (n - i > 2) {
	 ...
	 */
	public void install(PHPStructuredTextViewer sourceViewer,
			PHPStructuredPresentationReconciler backgroundPresentationReconciler) {
